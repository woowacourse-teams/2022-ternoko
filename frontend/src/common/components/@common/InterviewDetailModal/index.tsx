...
import { deleteCrewInterviewAPI } from '@/common/api';
import Accordion from '@/common/components/@common/Accordion';
import AskDeleteTimeModal from '@/common/components/@common/AskDeleteTimeModal';
import Modal from '@/common/components/@common/Modal';
import useModal from '@/common/components/@common/Modal/useModal';
import { CONFIRM_DELETE_MESSAGE, SUCCESS_MESSAGE } from '@/common/constants';
import { useLoadingActions } from '@/common/context/LoadingProvider';
import { useToastActions } from '@/common/context/ToastProvider';
import { InterviewType, MemberRoleType } from '@/common/types/domain';
