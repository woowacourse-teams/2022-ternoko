...
import { getDuplicatedNicknameStatusAPI } from '@/common/api';
import Button from '@/common/components/@common/Button/styled';
import InputAreaField from '@/common/components/InputAreaField';
...
import { CrewType as UserType } from '@/common/types/domain';
import { DuplicatedNicknameStatusType } from '@/common/types/domain';
