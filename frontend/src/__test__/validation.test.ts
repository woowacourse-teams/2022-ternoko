import { COACH_INTRODUCE_MIN_LENGTH } from '@/Coach/constants';
import { isValidIntroduceLength } from '@/Coach/validation';

import { CREW_APPLY_FORM_MIN_LENGTH } from '@/Crew/constants';
import { isValidApplyFormLength } from '@/Crew/validation';

import { NICKNAME_MAX_LENGTH, NICKNAME_MIN_LENGTH } from '@/Shared/constants';
