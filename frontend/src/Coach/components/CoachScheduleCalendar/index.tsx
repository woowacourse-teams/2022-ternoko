...
import { getDayNameOfWeek } from '@/Coach/util';
import { getCoachInterviewAPI } from '@/Crew/api';
import BabyShowMoreModal, {
  BabyModalPositionType,
} from '@/common/components/@common/BabyShowMoreModal';
import Button from '@/common/components/@common/Button/styled';
import Calendar from '@/common/components/@common/Calendar';
import Dimmer from '@/common/components/@common/Dimmer/styled';
import {
  dayNamesOfWeek,
  useCalendarState,
  useCalendarUtils,
} from '@/common/context/CalendarProvider';
import { DayNameOfWeekType, InterviewStatusType, InterviewType } from '@/common/types/domain';
import { isOverToday, separateFullDate } from '@/common/utils';
...
type CoachScheduleCalendarProps = {
  ...
  getHandleClickCommentButton: (interviewId: number, status: InterviewStatusType) => () => void;
};
