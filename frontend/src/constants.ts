export const PAGE = {
  ...
  SLACK_LOGIN_SERVER: `https://ternoko.slack.com/oauth?client_id=${process.env.SLACK_CLIENT_ID}&scope=&user_scope=openid%2Cemail%2Cprofile&redirect_uri=${process.env.SLACK_REDIRECT_URL}&state=&granular_bot_scope=1&single_channel=0&install_redirect=&tracked=1&openid_connect=1&response_type=code&team=`,
  CREW_HOME: '/',
