...
public class Interview {
    ...
    public static com.woowacourse.ternoko.core.domain.interview.Interview of(final LocalDateTime interviewDatetime,
                                                                             final Coach coach,
                                                                             final Crew crew,
                                                                             final List<FormItem> formItems) {
        return new com.woowacourse.ternoko.core.domain.interview.Interview(
                interviewDatetime,
    ...
    public void update(com.woowacourse.ternoko.core.domain.interview.Interview interview) {
    ...
    public com.woowacourse.ternoko.core.domain.interview.Interview copyOf() {
        return new com.woowacourse.ternoko.core.domain.interview.Interview(this.id,
