package com.woowacourse.ternoko.core.domain.comment.core.dto.response.core.domain.comment.core.domain.comment;
...
public class Comment {
    ...
    public static com.woowacourse.ternoko.core.domain.comment.core.domain.comment.Comment create(final Long memberId,
                                                                                                 final Interview interview,
                                                                                                 final String comment,
                                                                                                 final MemberType memberType) {
        validateCreateTime(interview);
        validateCreateStatus(interview, memberType);
        return new com.woowacourse.ternoko.core.domain.comment.core.domain.comment.Comment(memberId, interview, comment);
    }
