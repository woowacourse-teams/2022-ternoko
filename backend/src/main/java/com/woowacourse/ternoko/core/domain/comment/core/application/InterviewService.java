package com.woowacourse.ternoko.core.domain.comment.core.application;
...
public class InterviewService {
    ...
    public Long create(final Long crewId, final com.woowacourse.ternoko.core.domain.comment.core.dto.request.InterviewRequest interviewRequest) {
        validateDuplicateStartTimeByCrew(crewId, interviewRequest.getInterviewDatetime());

        final com.woowacourse.ternoko.core.domain.comment.core.domain.availabledatetime.AvailableDateTime availableDateTime = getAvailableTime(interviewRequest);
        validateOpenTime(availableDateTime);
        validateAfterToday(availableDateTime);
        availableDateTime.changeStatus(USED);

        final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview interview = convertInterview(crewId, interviewRequest);
    ...
    private void validateOpenTime(final com.woowacourse.ternoko.core.domain.comment.core.domain.availabledatetime.AvailableDateTime availableDateTime) {
    ...
    private void sendCreateMessage(final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview interview) {
        cache.setOrigin(AlarmResponse.from(interview));
        cache.setMessageType(SlackMessageType.CREW_CREATE);
    }

    private com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview convertInterview(final Long crewId, final com.woowacourse.ternoko.core.domain.comment.core.dto.request.InterviewRequest interviewRequest) {
        final com.woowacourse.ternoko.core.domain.comment.core.domain.member.crew.Crew crew = getCrewById(crewId);
        final com.woowacourse.ternoko.core.domain.comment.core.domain.member.coach.Coach coach = getCoachById(interviewRequest.getCoachId());
        final List<com.woowacourse.ternoko.core.domain.comment.core.domain.interview.formitem.FormItem> formItems = convertFormItem(interviewRequest.getInterviewQuestions());

        return com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview
                .of(interviewRequest.getInterviewDatetime(), coach, crew,
                formItems);
    }

    private List<FormItem> convertFormItem(final List<com.woowacourse.ternoko.core.domain.comment.core.dto.request.FormItemRequest> interviewQuestions) {
    ...
    private com.woowacourse.ternoko.core.domain.comment.core.domain.availabledatetime.AvailableDateTime getAvailableTime(final com.woowacourse.ternoko.core.domain.comment.core.dto.request.InterviewRequest interviewRequest) {
    ...
    private com.woowacourse.ternoko.core.domain.comment.core.domain.availabledatetime.AvailableDateTime getAvailableTime(final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview interview) {
    ...
    public com.woowacourse.ternoko.core.domain.comment.core.dto.response.InterviewResponse findInterviewResponseById(final Long interviewId) {
        final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview interview = getInterviewById(interviewId);
        return com.woowacourse.ternoko.core.domain.comment.core.dto.response.InterviewResponse.from(interview);
    }

    @Transactional(readOnly = true)
    public List<com.woowacourse.ternoko.core.domain.comment.core.dto.response.InterviewResponse> findAllByCrewId(final Long crewId) {
        final List<com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview> interviews = interviewRepository.findAllByCrewIdOrderByInterviewStartTime(crewId);
    ...
    @Transactional(readOnly = true)
    public com.woowacourse.ternoko.core.domain.comment.core.dto.response.ScheduleResponse findAllByCoach(final Long coachId, final Integer year, final Integer month) {
        final List<com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview> interviews = getInterviews(coachId, year, month);
        return ScheduleResponse.from(filterAndSortCanceledInterview(interviews));
    }

    private List<com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview> getInterviews(final Long coachId, final Integer year, final Integer month) {
    ...
    private List<com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview> filterAndSortCanceledInterview(final List<com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview> interviews) {
        return interviews.stream()
                .filter(interview -> !InterviewStatusType.isCanceled(interview.getInterviewStatusType()))
                .sorted(Comparator.comparing(
                        com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview::getInterviewStartTime))
                .collect(Collectors.toList());
    }

    public void update(final Long crewId,
                       final Long interviewId,
                       final com.woowacourse.ternoko.core.domain.comment.core.dto.request.InterviewRequest interviewRequest) {
        validateDuplicateStartTimeByCrew(crewId, interviewRequest.getInterviewDatetime());
        final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview interview = getInterviewById(interviewId);
        final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview origin = interview.copyOf();
    ...
    private void validateAfterToday(final com.woowacourse.ternoko.core.domain.comment.core.domain.availabledatetime.AvailableDateTime availableDateTime) {
        if (availableDateTime.isPast() || availableDateTime.isToday()) {
            throw new InvalidInterviewDateException(INVALID_INTERVIEW_DATE);
        }
    }

    private void changeAvailableDateTimeStatus(final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview originalInterview,
        ...
        changeAvailableTimeStatusIfPresent(originalInterview.getCoach().getId(),
                ...
                OPEN);
        final com.woowacourse.ternoko.core.domain.comment.core.domain.availabledatetime.AvailableDateTime afterTime = getAvailableTime(interviewRequest);
        afterTime.changeStatus(USED);
    }

    private com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview getInterviewById(Long interviewId) {
        return interviewRepository.findById(interviewId)
                .orElseThrow(() -> new InterviewNotFoundException(INTERVIEW_NOT_FOUND, interviewId));
    }

    private void sendUpdateMessage(final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview interview, final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview origin) {
    ...
    public void cancelAndDeleteAvailableTime(final Long coachId, final Long interviewId,
        ...
        final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview canceledInterview = cancel(coachId, interviewId);

        final com.woowacourse.ternoko.core.domain.comment.core.domain.availabledatetime.AvailableDateTime unavailableTime = getAvailableTime(canceledInterview);
        if (!onlyInterview) {
    ...
    private com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview cancel(final Long coachId, final Long interviewId) {
        final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview interview = getInterviewById(interviewId);
    ...
    private void sendCancelMessage(final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview interview) {
        cache.setOrigin(AlarmResponse.from(interview));
    ...
    private void sendDeleteMessage(final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview interview) {
        cache.setOrigin(AlarmResponse.from(interview));
    }
    ...
    private void deleteInterview(final Long crewId, final com.woowacourse.ternoko.core.domain.comment.core.domain.interview.Interview interview) {
