...
public class Comment {
    ...
    private com.woowacourse.ternoko.core.domain.comment.core.dto.response.core.domain.interview.Interview interview;

    private String comment;

    private Comment(final Long memberId, final com.woowacourse.ternoko.core.domain.comment.core.dto.response.core.domain.interview.Interview interview, final String comment) {
    ...
    public static Comment create(final Long memberId,
                                 final com.woowacourse.ternoko.core.domain.comment.core.dto.response.core.domain.interview.Interview interview,
                                 final String comment,
                                 final com.woowacourse.ternoko.core.domain.comment.core.dto.response.core.domain.member.MemberType memberType) {
        validateCreateTime(interview);
        validateCreateStatus(interview, memberType);
        return new Comment(memberId, interview, comment);
    }

    private static void validateCreateTime(final com.woowacourse.ternoko.core.domain.comment.core.dto.response.core.domain.interview.Interview interview) {
