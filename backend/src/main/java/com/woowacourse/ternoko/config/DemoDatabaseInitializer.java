...
public class DemoDatabaseInitializer {
    ...
    static class InitService {
        ...
        public void dbInit() {
            ...
            for (long i = 11L; i < 110L; i++) {
                coaches.add(new Coach(i, "이름" + i, "코치" + i, "이메일" + i + TEST_EMAIL,
                        "U1234567890" + i,
            ...
            for (long i = 110L; i < 210L; i++) {
                crews.add(new Crew(i, "이름" + i, "크루" + i, "이메일" + i,
                        "adsf",
                        "https://user-images.githubusercontent.com/54317630/184493934-9a2ba1bb-6051-4428-bb6a-5527c4f480d9.JPG"));
            }
    ...
    private static void addDefaultCoaches(ArrayList<Coach> coaches) {
        ...
        coaches.add(new Coach(9L, "이름", "토미", "토미" + TEST_EMAIL,
                ...
                "안녕하세요."));
        coaches.add(new Coach(10L, "터놓고", "터노코", "ternoko.official@gmail.com",
                "U03U8ETQ48Y",
                "https://user-images.githubusercontent.com/54317630/184493934-9a2ba1bb-6051-4428-bb6a-5527c4f480d9.JPG",
                "면담은 터놓고 하세요."));
    }
