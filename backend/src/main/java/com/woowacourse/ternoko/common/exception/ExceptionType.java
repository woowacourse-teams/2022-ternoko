...
public enum ExceptionType {
    ...
    COMMENT_NOT_FOUND(HttpStatus.BAD_REQUEST, "번째 코멘트를 찾을 수 없습니다."),
    ...
    INVALID_COMMENT_MEMBER_ID(HttpStatus.BAD_REQUEST, "해당 코멘트에 해당하지 않는 회원은 접근할 수 없습니다."),
    INVALID_COMMENT_INTERVIEW_ID(HttpStatus.BAD_REQUEST, "코멘트에 해당하지 않는 면담입니다."),
