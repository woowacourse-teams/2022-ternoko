...
public class MemberFixture {
    ...
    public static final Member COACH1 = new Coach(1L, "이름", "준", "test1@email.com", "imageUr");
    public static final Member COACH2 = new Coach(2L, "이름", "브리", "test2@email.com", "imageUrl");
    public static final Member COACH3 = new Coach(3L, "이름", "토미", "test3@email.com", "imageUrl");
    public static final Member COACH4 = new Coach(4L, "이름", "네오", "test4@email.com", "imageUrl");
