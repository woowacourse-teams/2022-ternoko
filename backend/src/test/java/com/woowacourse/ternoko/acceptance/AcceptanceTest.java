...
public class AcceptanceTest {
	...
	protected ExtractableResponse<Response> createReservation(final Long coachId, Header header,
		final String crewName) {
		final ReservationRequest reservationRequest = new ReservationRequest(crewName,
			AFTER_TWO_DAYS,
			FORM_ITEM_REQUESTS);

		return post("/api/reservations/coaches/" + coachId, header, reservationRequest);
	}
}
